...
<head>
    ...
    <title>Curso - Universidad La Gran Colombia</title>    
...
<body>
    <div class="container mt-4">
        <h2>Cursos</h2>
        <button type="button" class="btn btn-success btn-guardar-curso" onclick="mostrarOcultarFormulario()">Agregar nuevo curso</button>
